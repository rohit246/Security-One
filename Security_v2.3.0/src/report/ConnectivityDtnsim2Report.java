...
public class ConnectivityDtnsim2Report extends Report 
	...
	public void hostsConnected(DTNHost h1, DTNHost h2, Connection con) {
		if (isWarmup()) {
		...
		newEvent();
		write(createTimeStamp() + " " + connectionString(h1, h2) + " up" + "	" + h1 + "	" + h1.detectedNodes.size() + "	" + h2 + "	" + h2.detectedNodes.size());
	}
	
	public void hostsDisconnected(DTNHost h1, DTNHost h2, Connection con) {
		...
		newEvent();
		write(createTimeStamp() + " " + conString + " down" + "	" + h1 + "	" + h1.detectedNodes.size() + "	" + h2 + "	" + h2.detectedNodes.size());
	}
