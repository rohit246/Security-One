 ...
 */
public class MalnodeReport extends Report 
	...
	private void processEvent(final String action, final DTNHost host1, 
		...
		write(getSimTime() + "		" + (host1 != null ? host1 + "		" + host1.detectedNodes.size() + "		" + host1.maloverhead : "") + "		" + (host2 != null ? host2 + "		" + host2.detectedNodes.size() + "		" + host2.maloverhead : ""));
	}
